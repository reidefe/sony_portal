		...
		<article class="doc-body">
			<div class="doc-intro">
				...
				<p>
					...
					disagree with any part of these Terms, you may not access the Service. These Terms
			...
			<section class="doc-section" id="acceptance">
				...
				<p>By creating an account or using the Service, you represent that:</p>
				<ul>
					<li>You are at least 13 years of age (or 16 in the EEA/UK, or the age of digital consent in your jurisdiction);</li>
			...
			<section class="doc-section" id="course-enrolment">
				<h2>3. Course enrolment and access</h2>
				<h3>3.1 Enrolment</h3>
			...
			<section class="doc-section" id="prohibited-conduct">
				...
				<ul>
					...
					<li>Share, resell, or distribute course content to others who have not enrolled;</li>
					<li>Record, screenshot, or download course materials except where the course explicitly permits it;</li>
					<li>Attempt to circumvent technological protection measures on the platform;</li>
				...
				<p>Violation of these prohibitions may result in immediate termination of your account and, where appropriate, referral to law enforcement authorities.</p>
			</section>

			<section class="doc-section" id="user-content">
				<h2>7. User-generated content</h2>
				<p>You are solely responsible for any content you submit, post, or display on the Service ("User Content"). By submitting User Content, you warrant that:</p>
				<ul>
			...
			<section class="doc-section" id="disclaimer">
				...
				<ul>
					...
					<li>Course content will result in any particular career outcome or qualification.</li>
				</ul>
			</section>
			...
			<section class="doc-section" id="changes">
				...
				<p>We reserve the right to modify these Terms at any time. When we make material changes, we will provide at least 14 days' notice by email and/or a prominent notice on the Service before the new terms take effect. Your continued use of the Service after the effective date constitutes acceptance of the revised Terms. If you do not agree, you must stop using the Service.</p>
			</section>
...
<script lang="ts">
	const tocItems = [
		...
		{ id: 'course-enrolment', label: '3. Course enrolment & access' },
...
.toc-list a { font-size: .8125rem; color: var(--color-text-muted); transition: color var(--transition); line-height: 1.5; }
...
.doc-section h2 { font-size: 1.375rem; font-weight: 800; margin-bottom: 1rem; padding-top: 1rem; border-top: 1px solid var(--color-border); }
